...
import { DropDown, SearchInput, NetflixIcon } from "@fcastillo90/netflix-ui";
import { NAV_BAR_HEIGHT } from "@fcastillo90/constants";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Grid item>
            <DropDown popperId="account" showArrow={true}>
